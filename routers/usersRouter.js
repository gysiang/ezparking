  ...
  router() {
    router
      ...
      .get(
        "/currentUserProfile",
        authSession,
        this.controller.getCurrentUserProfile.bind(this.controller)
      )
      .post(
        "/uploadAvatar",
        authSession,
      ...
      .put(
        "/updateUserAvatar",
        authSession,
        this.controller.updateUserAvatar.bind(this.controller)
      )
      .put(
        "/currentUserProfile",
        authSession,
        this.controller.editCurrentUserProfile.bind(this.controller)
      )
      .post(
        "/logout",
        authSession,
